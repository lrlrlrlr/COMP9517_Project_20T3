...
class MASK_RCNN(object):
    _defaults = {
        ...
        # When using coco data set detection, IMAGE_MIN_DIM=1024, IMAGE_MAX_DIM=1024, RPN_ANCHOR_SCALES=(32, 64, 128, 256, 512)
        "RPN_ANCHOR_SCALES": (32, 64, 128, 256, 512),
        "IMAGE_MIN_DIM": 1024,
        "IMAGE_MAX_DIM": 1024,
        
        # Reduce the picture size if the video memory is insufficient
        # Adjust the anchors at the same time
        #"IMAGE_MIN_DIM": 512,
        #"IMAGE_MAX_DIM": 512,
    ...
    def generate(self):
        ...
        # Load the model
        # If the model structure is already included in the original model, load it directly.
        # Otherwise, build the model first and then load
